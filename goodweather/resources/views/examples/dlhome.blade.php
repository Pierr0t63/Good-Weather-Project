...
<body >
    ...
    <header class="container-fluid justify-content-center text-center">
        ...
        <div class="row justify-content-center text-center">
            ...
            <form class="form-inline active-white-2 col-4">
                <input class="form-control w-100 text-white" type="text" id="citysearch" placeholder="Renseignez votre ville, code postal..." aria-label="Search" title="Renseignez votre position">
            </form>
    ...
    <!-- Jquery Widgets for Autocompletion-->
             ...
             function log( message ) {
                ...
                $( "#citysearch" ).autocomplete({
                  ...
                  select: function( event, ui ) {
                    dlhome->citysearch(ui.item.name);
                  }
                } );
              } );
